            ...
            if (animation != null) {
                ...
                if (hud) {
                    g.drawImage(animation.sheet, (int) position.X, (int) position.Y, (int) position.X
                            ...
                            animation.getRectangle().y + getHeight(), null);
                } else {
                ...
                if (hud) {
                    g.drawImage(singleImg, (int) position.X, (int) position.Y, null); 
                } else {
                    g.drawImage(singleImg, (int) position.X - Global.camera.x, (int) position.Y - Global.camera.y, null); 
                }
            }
        }
    }
